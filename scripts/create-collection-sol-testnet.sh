...
npx ts-node ./src/cli/controls/addPhase.ts -d 9wkk8xqL9BRcsRF5XRGHvnE99VbgJLzuh6TPyWVvsZJd -k ~/.config/solana/id.json -r https://testnet.dev2.eclipsenetwork.xyz  --maxMintsPerWallet 100 --maxMintsTotal 1150 --priceAmount 0 -s 1709564319 -e 1959564319


npx ts-node ./src/cli/controls/mintWithControls.ts -d 9wkk8xqL9BRcsRF5XRGHvnE99VbgJLzuh6TPyWVvsZJd -k ~/.config/solana/id.json -r https://testnet.dev2.eclipsenetwork.xyz  -p 0 -n 1
